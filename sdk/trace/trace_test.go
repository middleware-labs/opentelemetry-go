...
func TestRecordError(t *testing.T) {
	scenarios := []struct {
	...
	}{
		{
			...
			typ: "github.com/middleware-labs/otel/internal/internaltest.TestError",
			msg: "test error",
		},
		{
...
func TestRecordErrorWithStackTrace(t *testing.T) {
	...
	assert.Truef(t, strings.HasPrefix(gotStackTraceFunctionName[1], "github.com/middleware-labs/otel/sdk/trace.recordStackTrace"), "%q not prefixed with github.com/middleware-labs/otel/sdk/trace.recordStackTrace", gotStackTraceFunctionName[1])
	assert.Truef(t, strings.HasPrefix(gotStackTraceFunctionName[3], "github.com/middleware-labs/otel/sdk/trace.(*recordingSpan).RecordError"), "%q not prefixed with github.com/middleware-labs/otel/sdk/trace.(*recordingSpan).RecordError", gotStackTraceFunctionName[3])
}
...
func TestSpanCapturesPanicWithStackTrace(t *testing.T) {
	...
	assert.Truef(t, strings.HasPrefix(gotStackTraceFunctionName[1], "github.com/middleware-labs/otel/sdk/trace.recordStackTrace"), "%q not prefixed with github.com/middleware-labs/otel/sdk/trace.recordStackTrace", gotStackTraceFunctionName[1])
	assert.Truef(t, strings.HasPrefix(gotStackTraceFunctionName[3], "github.com/middleware-labs/otel/sdk/trace.(*recordingSpan).End"), "%q not prefixed with github.com/middleware-labs/otel/sdk/trace.(*recordingSpan).End", gotStackTraceFunctionName[3])
}
