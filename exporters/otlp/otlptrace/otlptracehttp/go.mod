module github.com/middleware-labs/otel/exporters/otlp/otlptrace/otlptracehttp
...
require (
	...
	github.com/middleware-labs/otel/exporters/otlp/otlptrace v1.15.0-rc.2
...
replace github.com/middleware-labs/otel/exporters/otlp/otlptrace => ../
